...
def test_backend_selection_auto_prefers_gpu():
    """Test that auto mode prefers GPU if available, falls back to NumPy."""
    backend = get_backend("auto")
    # Should be cupy if GPU available, otherwise numpy
    if _cupy_available():
